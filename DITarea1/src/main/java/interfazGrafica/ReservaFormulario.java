 ...
 * la aplicación de gestión hotelera. Permite a los usuarios ingresar información
 * para realizar una reserva, como nombre, apellidos, teléfono, tipo de evento,
 * fecha, número de asistentes, tipo de cocina, número de jornadas (en caso de un
 * congreso) y si se necesitan habitaciones para el evento (en caso de un congreso).
 * Esta ventana se muestra como un cuadro de diálogo modal.
 * 
 * @author julio
 */
public class ReservaFormulario extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        telefonoTextField.setToolTipText("Escriba el teléfono en este apartado");
    ...
    /**
     * Realiza la reserva utilizando los datos ingresados por el usuario y muestra
     * los detalles de la reserva en una ventana de diálogo.
     */
    public void realizarReserva() {
        ...
        ventanaReserva.setNombreCompleto(reserva.getNombre() + " " + reserva.getApellidos());
    ...
    /**
     * Determina el tipo de evento seleccionado (Presentación, Jornada o Congreso).
     *
